...
router.get("/system/permissions" , parseAuthHeaderMiddleware() ,parseAuthorizationMiddleware(), requiredPermission(["view_permissions"]) , SystemSettingsController.getPermissionsController)

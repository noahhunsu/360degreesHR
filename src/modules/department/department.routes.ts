...
const router = Router()
router.post("/" , parseAuthHeaderMiddleware(), requiredPermission(["create_department"]),validate(createDepartmentSchema), DepartmentController.createDepartmentController)
